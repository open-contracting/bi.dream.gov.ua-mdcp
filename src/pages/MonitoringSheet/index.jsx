...
export default function MonitoringSheet({ title , appDisclaimer , pageTitle, ExportChartFootnote, menuItemsStrings}) {
  useEffect(() => {
                ...
                <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                  ...
                  <div className="row justify-content-center">
                    <div className="col-12">
                      {/* table */}
                      <QlikCard
                        id="3fc15ff7-dcaf-445a-838e-debc72c51742"
                        // height="170px"
                        height="max(calc(100vh - 165px), 200px)"
                        showHeader={true}
                        showMaximize={false}
                        showExport={true}
                        showPdfExport={false}
